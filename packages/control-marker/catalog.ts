...
export class LayerCatalog {
     ...
     *
     */
    constructor(ctx: MarkerManager, layer: MarkerLayerProperties, features: TMarkerFeature[]) {
        this.element = dom.createHtmlElement('div', [
            ...
            dom.createHtmlElement('div', ["mlb-ctrl-marker-layer-content"], features.map(f => {
                return dom.createHtmlElement('div', ["mlb-ctrl-marker-layer-content-item"], [
                    dom.createHtmlElement("div", ["mlb-ctrl-marker-layer-content-item-prefix"], [
                        dom.createHtmlElement('div', [], []),
                        dom.createHtmlElement('div', [], [f.properties.name])
                    ], {
