...
export class BackToOriginControl extends MapControl<IBackControlLanguage> {
    ...
    constructor(public options: BackToOriginControlOptions = {}) {
        ...
        options.svg ??= `<svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    createElement(map: mapboxgl.Map): HTMLElement {
        ...
        const element = dom.createHtmlElement('div', ["mlb-ctrl-back", "maplibregl-ctrl-group", "maplibregl-ctrl", "mapboxgl-ctrl", "mapboxgl-ctrl-group"], [], {
            onInit: e => {
